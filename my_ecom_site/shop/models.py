...
class Product(models.Model):
    ...
    color = models.ForeignKey(Product_colors, on_delete=models.SET_NULL, null=True) 
    
    size = models.ForeignKey(Product_sizes, on_delete=models.SET_NULL, null=True)
    
    price_range = models.ForeignKey(Product_price, on_delete=models.SET_NULL, null=True)
